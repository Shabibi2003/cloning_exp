...
if st.session_state.script_choice == "monthly_trends":
    ...
    def plot_and_display_line_charts(indoor_df, outdoor_df, pollutant_display_names, all_figs):
        ...
        for pollutant in pollutant_display_names.keys():
            ...
            ax.set_title(f"{pollutant_display_names[pollutant]} - Indoor vs Outdoor", fontsize=12)
    ...
    def plot_residential_seasonal_line_chart(indoor_df, pollutant, year, all_figs):
        ...
        ax.set_title(f"Yearly {pollutant.upper()} Trends for Residential Buildings ({year})", fontsize=12)
        ax.set_xlabel("Date", fontsize=12)
